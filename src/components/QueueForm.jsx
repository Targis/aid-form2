  ...
  return (
    <div style={{ marginBottom: '2em' }}>
      ...
      <Typography color="inherit" variant="h6" component="div" sx={{ mb: 4 }}>
        ...
        від чеської гуманітарної організації "Людина в біді"
      </Typography>

      <Typography color="inherit" variant="p" component="div" sx={{ mb: 4, textAlign: 'left' }}>
        ❗ ВАЖЛИВО: Прийом на реєстрацію буде проводитись виключно за попереднім записом в електронній черзі. <br />
        Один член сім'ї реєструє всіх інших членів родини.<br /><br />
        Для реєстрації потрібно надати інформацію з оригіналів документів, зокрема:
        <ul>
          <li>паспорт кожного члена родини, свідоцтво про народження кожної дитини;</li>
          <li>реєстраційний номер облікової картки платника податків (ідентифікаційний код) кожної особи, яка реєструється;</li>
          <li>довідка ВПО кожного члена родини, який має статус ВПО (якщо є в наявності).</li>
        </ul>
      </Typography>
